...
- Follow the certificate [generation instructions in UI](https://mkto-ab530131.com/MjUwLVdJVS0wMDcAAAGZHGTwtMT-ceFP_sPxee6fNjhLAJBSI3_p2Gf-Adb6Tj6ykt3ztTZcZzWiAVoJrrfXaYx_To4=)
- Or use your own certificates following Temporal's requirements
- Save the certificate files securely

3. **Create Namespace**
- Go to Temporal Cloud Console
- Create a namespace (e.g., default, dev-namespace, prod-namespace)
...
Update your Temporal Worker to use the initialize OpenTelemetry for metrics:
...
Update your Temporal Workflow Starter to use the initialize OpenTelemetry for metrics:
...
1. Start the worker with metrics enabled:
```bash
...
The `Metrics` tab displays metrics for your Temporal application.

<figure data-zoomable align='center'>
<img src="/img/docs/instrumentation/temporal-metrics.webp" alt="Metrics view"/>
<figcaption><i>Metrics analysis with workflow details</i></figcaption>
</figure>
